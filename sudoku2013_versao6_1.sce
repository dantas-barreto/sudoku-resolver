// Programa para resolucao de problemas de Sudoku, v6
// Janeiro de 2013
// Autor: Lin Chau Jen
//
// Documentacao
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=InLine(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for k=1:9
        for n=1:9
            cont=0;
            for i=Ls(k,1):Ls(k,3)
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=MacroColuna(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     for n=1:9,
         if Fa#(n)<=7 then
             for j=1:9,
...
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=..
Post(n,i,j,Ls,Cs,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch),
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=MacroLinha(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     for n=1:9,
         if Fa#(n)<=7 then
             for i=1:9,
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parexlin(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for i=1:9
        if Fa_f(i)>2 then
            ncand=0;
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parexco(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for j=1:9
        if Fa_c(j)>2 then
            ncand=0;
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parexse(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for k=1:9
        if Fa_s(k)>2 then
            ncand=0;
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Paroco(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for j=1:9
...
// Subrotina Parolin
// Par oculto na linha
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parolin(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for i=1:9
        // Procura de numeros candidatos
        ncand=0;
...
// Subrotina Parose
// Par oculto no setor
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parose(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for k=1:9
        // Procura de numeros candidatos
        ncand=0;
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch] =..
    Post(n,i,j,Ls,Cs,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch),
...
// Atualizacao de vetores e matrizes  
  ...
  A(i,j)=n; // Atribui-se o valor para a celula
  Nprch=Nprch+1;
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCand(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    for i=1:9, for j=1:9
        if A(i,j)==0 then //celula vazia
...
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=..
Post(Qual(i,j,1),i,j,Ls,Cs,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch),
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCelColuna(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     for j=1:9
         for n=1:9
             cont=0;
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCelLinha(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
//
     for i=1:9
         for n=1:9
...
function [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCelSetor(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     for k=1:9
         for n=1:9
             cont=0;
...
// -----------------------------------------------------------------------------
// 1. Inicializacao
//1.1. Parametros, vetores e matrizes
//
...
//
A=zeros(9,9);
for i=1:9,for j=1:9,A(i,j)=AA(i,j);end,end,
  //impressao do problema
  ...
  for i=1:9,for j=1:9,
  if A(i,j) <> 0 then
    [Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch] =Post(A(i,j),..
    i,j,Ls,Cs,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch),
  end, //end if
end,end,
...
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCand(Ls,Cs,p,strng,xch,..
ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     // 3.2. "Macro-linha"
//[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=MacroLinha(Ls,Cs,p,strng,xch,..
//ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     // 3.3. "Macro-coluna"
//[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=MacroColuna(Ls,Cs,p,strng,xch,..
//ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     // 3.4. Unica posicao para o numero, considerando...
     //3.4.1. Unica posicao considerando a linha
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCelLinha(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     //3.4.2. Unica posicao considerando a coluna
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCelColuna(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
     //3.4.3. Unica posicao considerando o setor
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=UnoCelSetor(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
//
...
//
if Nprch<>81 then
    if FirstFlagDificil then
        FirstFlagDificil=%f;
        classe=2;
        if PressCode>1 then
          xfrect(1,-19.1,18.1,1);
          p.font_foreground=color("white");
          xstring(1.2,-20.1,"Alcancou nivel dificil");
          pause;
          p.font_foreground=color("black");
          xstring(1.2,-20.1,"Alcancou nivel dificil");
        end //if PressCode
    end //if FirstFlagDificil
//
...
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=InLine(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    // 4.2. Reducao de candidatos por "par oculto"
    // 4.2.1. "Par oculto" na linha
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parolin(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    // 4.2.2. "Par oculto" na coluna
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Paroco(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)   
    // 4.2.3. "Par oculto" no setor
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parose(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    // 4.3. Reducao do numero de candidatos pelo criterio do "par explicito"
    // 4.3.1. Par explicito na linha
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parexlin(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    // 4.3.2. Par explicito na coluna
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parexco(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    // 4.3.3. Par explicito no setor
[Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch]=Parexse(Ls,Cs,p,strng,..
xch,ych,t_sleep,n_sleep,PressCode,Fa#,Qual,Fa_f,Fa_c,Fa_s,Exi#f,Exi#c,Exi#s,A,Nprch)
    //
end //if Nprch<>81
...
disp(Nprch,"N_preenchidos =");
select classe
    case 1,disp("O problema é da categoria # facil/medio #");
    case 2,disp("O problema é da categoria # dificil #");
    case 3,disp("O problema é da categoria # diabolico #");
end
//
